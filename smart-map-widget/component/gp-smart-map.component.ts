...
import { C8Y_DEVICE_GROUP, C8Y_DEVICE_SUBGROUP } from '../common/tokens';
...
export class GPSmartMapComponent implements OnInit, OnDestroy, AfterViewInit, OnChanges {
    ...
    private __initMapBounds(mapBounds) {
        if (!mapBounds) {
            const lat = this.rootLat != null ? this.rootLat : 49.814334;
            const long = this.rootLong != null ? this.rootLong : 8.637085;
