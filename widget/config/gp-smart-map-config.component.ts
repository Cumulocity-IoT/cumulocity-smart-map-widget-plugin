 ...
 */
import { Component, OnInit, Input, isDevMode, OnDestroy, ViewEncapsulation, DoCheck, ChangeDetectionStrategy } from '@angular/core';
...
@Component({
  ...
  styleUrls: ['./../../node_modules/@ng-select/ng-select/themes/default.theme.css', './gp-smart-map-config.component.css'],
...
export class GPSmartMapConfigComponent implements OnInit, OnDestroy, DoCheck {
  ...
  constructor(private cmonSvc: Commonc8yService ) {
  }
