...
# Smart Map Widget for Cumulocity [<img width="35" src="https://user-images.githubusercontent.com/32765455/211497905-561e9197-18b9-43d5-a023-071d3635f4eb.png"/>](https://github.com/Cumulocity-IoT/cumulocity-smart-map-widget-plugin/releases/download/1.0.4/sag-ps-pkg-smartmap-runtime-widget-1.0.4.zip)
...
*  **[Smart Map Settings](https://github.com/Cumulocity-IoT/cumulocity-smart-map-settings-widget-plugin):** Configure multiple floor plans with live preview using Smart Map Settings widget.
...
* This widget support runtime deployment. Download [Runtime Binary](https://github.com/Cumulocity-IoT/cumulocity-smart-map-widget-plugin/releases/download/1.0.4/sag-ps-pkg-smartmap-runtime-widget-1.0.4.zip) and install via Administrations --> Ecosystems --> Applications --> Packages.
